	...
	let content = `<div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active">
                <img class="d-block img-fluid" src="media/plat1.jpg" alt="First slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="media/plat2.jpg" alt="Second slide">
              </div>
              <div class="carousel-item">
                <img class="d-block img-fluid" src="media/plat3.jpg" alt="Third slide">
              </div>
            </div>
			...
			if (response.data.objects[i].type === 2) {
				content += `<div class="col-lg-4 col-md-6 mb-4">
              		<div class="card h-100">
                		<a href="#" onclick="getItem(this.id)" id="` + response.data.objects[i].id + `"><img class="card-img-top" src="media/plat_item.png" alt=""></a>
                		<div class="card-body">
                  		<h4 class="card-title">
